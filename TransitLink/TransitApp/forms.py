...
class SaveSchedule(forms.ModelForm):
    ...
    fare = forms.FloatField(min_value=0, max_value=9999)
    ...
    def clean_code(self):
        ...
        pref = datetime.today().strftime('%d%m%Y')
        code = str(1).zfill(4)
        while True:
    ...
    def clean_bus(self):
        ...
        try:
            ...
            raise forms.ValidationError("Bus is not recognised.")
    ...
    def clean_depart(self):
        ...
        try:
            ...
            raise forms.ValidationError("Depart is not recognised.")
    ...
    def clean_destination(self):
        ...
        try:
            ...
            raise forms.ValidationError("Destination is not recognised.")
...
class SaveBooking(forms.ModelForm):
    ...
    def clean_schedule(self):
        ...
        try:
            ...
            raise forms.ValidationError(f"Trip Schedule is not recognised.")
